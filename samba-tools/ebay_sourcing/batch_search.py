...
ATEEZ_KW = [
    "에이티즈 골든아워 포토카드", "에이티즈 포토카드", "ateez 포카",
    "에이티즈 트레카", "에이티즈 미공포",
    "에이티즈 골든아워 part.5 포카", "에이티즈 골든아워 part.4 포카",
    "에이티즈 골든아워 part.3 포카", "에이티즈 the world 포카",
    "에이티즈 bouncy 포카", "에이티즈 크레이지폼 포카", "에이티즈 limitless 포카",
    "에이티즈 zero fever 포카", "에이티즈 팬미팅 포카", "에이티즈 시즌그리팅 포카",
    "에이티즈 홍중 포카", "에이티즈 성화 포카", "에이티즈 윤호 포카",
    "에이티즈 여상 포카", "에이티즈 산 포카", "에이티즈 민기 포카",
    "에이티즈 우영 포카", "에이티즈 종호 포카", "에이티즈 위버스 포카",
]
# 이미 등록된 인기카드(리자몽/팬텀/피카츄/잉어킹/냐옹/이상해꽃/지가르데/망나뇽/
# 다크라이) 제외한 '다른 카드'만 — generic 검색은 인기카드 flood라 뺐다.
POKE_KW = [
    "파오젠 ex", "무쇠머신 ex", "테라파고스 ex", "마스카나 ex", "라우드본 ex",
    "오거폰 ex", "챠데스 ex", "루카리오 ex", "뮤츠 ex", "가브리아스 ex",
    "님피아 ex", "리자드 ex", "가이오가 ex", "루기아 ex", "레쿠쟈 ex",
    "삐삐 ex", "픽시 ex", "잠만보 ex", "개굴닌자 ex", "그우린차 ex",
    "대여르 ex", "우라오스 vmax", "자시안 v", "리자몽 vstar", "뮤 vmax",
    "세레비 ex", "파치리스 ex", "밤선인 ex", "타부자고 ex", "드닐 ex",
    "이브이 히어로즈", "님피아 vmax", "리피아 vstar", "글레이시아 vstar",
    "꼬부기 ar", "파이리 ar", "이상해씨 ar", "닌자스피너 sar", "인페르노x sr",
    "포푸니라 ex", "우롱 ex", "안농 ar", "장크로 ex",
]


# 포토카드 검색 노이즈(거래글·앨범·디지털) 추가 제외
EXTRA_BAD = [
    "교환", "앨범", "cdp", "다이어리", "나눔", "포카x", "포카 x",
    "빈판", "탑로더", "슬리브", "받아요", "찾아요", "구해요", "택포x",
    # 포켓몬: 등급카드/외국판/뽑기팩/복수장 = 한국 낱장 오표기 방지
    "등급", "bgr", "brg", "gem", "북미", "일어", "일본판", "일판",
    "서치", "낱팩", "서치팩", "연번", "미개봉", "박스", "부스터",
    "2장", "3장", "4장", "5장", "2연", "장세트",
    # 번들/굿즈(단일 포카 아님)
    "포스터", "우산", "인형", "키링", "1set", "친필", "싸인", "사인",
    "럭드", "유닛포카", "단체", "올멤", "럭키드로우",
]
MUST = {  # 라벨별 이름 필수 포함(최소 하나)
    "A": ["포카", "포토카드", "트레카"],
    "S": ["포카", "포토카드", "트레카"],
    "P": ["포켓몬", "리자몽", "뮤", "피카츄", "이상해", "냐옹", "개굴", "팬텀", "잉어킹"],
}
STRAYKIDS_KW = [
    "스키즈 방찬 포카", "스키즈 리노 포카", "스키즈 창빈 포카", "스키즈 현진 포카",
    "스키즈 한 포카", "스키즈 필릭스 포카", "스키즈 승민 포카", "스키즈 아이엔 포카",
    "스키즈 락스타 포카", "스키즈 파이브스타 포카", "스키즈 매니악 포카",
    "스키즈 오디너리 포카", "스키즈 노이지 포카", "스키즈 케이스143 포카",
    "스키즈 소셜패스 포카", "스키즈 홀리데이 포카", "스키즈 런잇 포카",
    "스키즈 this and that 포카", "스트레이키즈 시즌그리팅 포카", "스키즈 미공포",
    "스트레이키즈 트레카", "스키즈 위버스 포카", "스키즈 합범 포카", "스키즈 팬미팅 포카",
    "스키즈 방찬 미공포", "스키즈 현진 미공포", "스키즈 필릭스 미공포",
    "스키즈 한 미공포", "스키즈 승민 미공포", "스키즈 아이엔 미공포",
    "스키즈 리노 미공포", "스키즈 창빈 미공포", "스키즈 도미네이트 포카",
    "스키즈 언락 포카", "스키즈 카르마 포카", "스키즈 스테이 포카",
    "스키즈 애드머 포카", "스키즈 컴백쇼 포카", "스키즈 팝업 포카",
]
# 복수장 묶음/피규어/덱/굿즈 = 단일 낱장 아님 (한국어 표기 포함 — 2026-07-27 워치·교통카드 오등록 재발)
MULTI_BAD = ["및", ",", "/", "&", "＆", "덱", "테라리움", "리멘트", "피규어",
             "100덱", " box", "15팩", "낱팩",
             "시계", "워치", "스트랩", "watch", "정품", "빈티지",
             "교통카드", "이즐", "ezl", "ez1", "뱃지", "배지", "텀블러", "굿즈",
             "키링", "인형", "포스터", "우산", "쿠션", "스티커", "부채"]
# 포켓몬 단일 낱장 판별용 레어도 토큰(하나는 있어야 특정 카드로 인정)
RARITY = ["sar", " ar", "ar ", " sr", "sr ", " ur", "ur ", "rr", "vmax",
          "vstar", " ex", "ex ", "gx", "프로모", "promo"]
# 특정 포켓몬(이게 없으면 '포켓몬카드 낱장' 뭉치 = 어떤 카드인지 불명 → 제외)
POKE_SPECIFIC = ["리자몽", "팬텀", "냐옹", "피카츄", "뮤", "이상해", "개굴", "잉어킹",
                 "가디안", "무장조", "망나뇽", "지가르데", "이벨타르", "루카리오",
                 "뮤츠", "가이오가", "close", "sar", "sr", "ar", "ur", "rr"]
...
def collect(w: Whale, keywords, label):
    ...
    for kw in keywords:
        ...
        for it in items:
            ...
            seen_name.add(key)
            kw_taken += 1
            out.append({"bpid": str(pid), "price": price,
                        "name": p.get("name") or nm, "img": int(p.get("imageCount") or 1)})
            print(f"  [{label}] {len(out):2d} {pid} | {price:,}원 | {(p.get('name') or nm)[:34]}")
    return out
...
def main():
    ...
    try:
        ...
        pass
    result = {"ateez": prev.get("ateez", []), "pokemon": prev.get("pokemon", []),
              "skz": prev.get("skz", [])}
    groups = {"ateez": (ATEEZ_KW, "A"), "pokemon": (POKE_KW, "P"),
              "skz": (STRAYKIDS_KW, "S")}
    w = Whale()
    try:
