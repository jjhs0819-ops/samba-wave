...
_CATEGORY_GROUP: dict[str, str] = {
    ...
    "골프": "sports",
    "헬스": "sports",
    # ★2026-08-02 — 스포츠 용품류(cat2="기구/용품/장비")가 어떤 그룹에도 안 걸려
    # etc(0000000035 기타재화)로 폴백했고, SSG 가 그 고시분류에 **디지털 고시**
    # (0000000157 상품제공방식 CD/다운로드/스트리밍)를 요구해 영구 등록실패했다
    # (2026-08-02 보류건 전송 실측: 106/161 이 이 사유). 물리 상품이므로 sports
    # (→0000000001 의류 고시)로 태워 통과시킨다 — 위 sports 매핑과 동일 전략.
    "기구/용품/장비": "sports",
    "피트니스": "sports",
    "캠핑": "sports",
    "낚시": "sports",
