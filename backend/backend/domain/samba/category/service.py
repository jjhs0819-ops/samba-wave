...
_SYNONYM_MAP: dict[str, list[str]] = {
    ...
    "점퍼": ["점퍼", "재킷", "자켓", "잠바"],
    "재킷": ["재킷", "자켓", "점퍼", "재킷/점퍼"],
    "바지": ["바지", "팬츠", "하의", "트레이닝", "트레이닝복", "스포츠"],
    "팬츠": ["바지", "팬츠", "하의", "트레이닝", "트레이닝복", "스포츠"],
    "슬랙스": ["슬랙스", "정장바지", "드레스팬츠"],
    ...
    "코트": ["코트", "롱코트", "하프코트"],
    "패딩": ["패딩", "다운재킷", "다운", "패딩점퍼"],
    "조거": ["조거", "조거팬츠", "트레이닝", "트레이닝복", "스포츠"],
    "트레이닝": ["트레이닝", "트레이닝복", "조거", "운동복", "스포츠"],
    "상의": ["상의", "탑", "톱", "의류", "스포츠"],
    "하의": ["하의", "바지", "팬츠", "보텀", "트레이닝", "트레이닝복", "스포츠"],
