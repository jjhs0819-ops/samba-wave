...
_LOTTEON_M_TO_F: dict[str, str] = {
    ...
    "패션의류 > 남성의류 > 점퍼": "패션의류 > 여성의류 > 점퍼/재킷",
    "패션의류 > 남성의류 > 트레이닝복": "패션의류 > 여성의류 > 트레이닝복",
    "패션의류 > 남성의류 > 패딩": "패션의류 > 여성의류 > 패딩",
    # 롯데ON DB에 "여성의류 > 청바지/바지" 경로 없음 → 트레이닝복 경유 등록
    # TODO: 롯데ON 카테고리 DB에서 여성 팬츠 전용 경로 확인 후 업데이트 필요
    "패션의류 > 남성의류 > 청바지": "패션의류 > 여성의류 > 트레이닝복",
    "패션의류 > 남성의류 > 바지": "패션의류 > 여성의류 > 트레이닝복",
...
_MUSINSA_LOTTEON_RULES: dict[str, str] = {
    ...
    "아우터 > 트레이닝 재킷": "스포츠의류/운동화 > 남성스포츠의류 > 트레이닝복",
    ...
    "바지 > 트레이닝/조거 팬츠": "스포츠의류/운동화 > 남성스포츠의류 > 트레이닝복",
    ...
    "스포츠/레저 > 하의 > 트레이닝 팬츠": "스포츠의류/운동화 > 남성스포츠의류 > 트레이닝복",
    "스포츠/레저 > 하의 > 숏팬츠": "스포츠의류/운동화 > 남성스포츠의류 > 반바지",
    "스포츠/레저 > 아우터 > 기타 점퍼/재킷": "스포츠의류/운동화 > 남성스포츠의류 > 점퍼",
    "스포츠/레저 > 아우터 > 트레이닝 재킷": "스포츠의류/운동화 > 남성스포츠의류 > 트레이닝복",
