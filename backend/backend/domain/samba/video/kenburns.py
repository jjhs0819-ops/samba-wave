...
def _random_effect_params() -> dict[str, float]:
  ...
  effects = [
    {"zoom_start": 1.0, "zoom_end": 1.15, "pan_x": 0.3, "pan_y": 0.1},   # 줌인 + 우측
    {"zoom_start": 1.15, "zoom_end": 1.0, "pan_x": -0.3, "pan_y": -0.1},  # 줌아웃 + 좌측
    {"zoom_start": 1.0, "zoom_end": 1.12, "pan_x": 0.0, "pan_y": 0.3},   # 줌인 + 아래
    {"zoom_start": 1.1, "zoom_end": 1.0, "pan_x": 0.2, "pan_y": -0.2},   # 줌아웃 + 우상단
    {"zoom_start": 1.0, "zoom_end": 1.18, "pan_x": -0.2, "pan_y": 0.15},  # 줌인 + 좌하단
  ]
...
def generate_kenburns_video(
  ...
  logger.info(f"[영상생성] 완료 — {output_path} ({final.duration:.1f}초, {file_size / 1024 / 1024:.1f}MB)")
  return output_path
