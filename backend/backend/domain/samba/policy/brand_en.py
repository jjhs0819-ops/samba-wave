...
- 매핑에 없는(표기 불확실한) 브랜드는 빈 문자열 반환 → 국문 단독 노출(오역 방지).
"""
...
BRAND_EN_MAP: dict[str, str] = {
    ...
    "마스마룰즈": "MASMARULEZ",
    "르무통": "LEMOUTON",
    "셀렙샵에디션": "CELEBSHOP EDITION",
    # 2026-08-13 신세계몰 전송 규칙("맨 앞 영문 브랜드명 노출") 대응 —
    # 실제 취급 브랜드(samba_collected_product.brand) 전수 대조 후 추가.
    "디아도라": "DIADORA",
    "왁": "WAAC",
    ...
    "클락스 오리지널스": "CLARKS ORIGINALS",
    "예루살렘 샌들": "JERUSALEM SANDALS",
    "아부스": "ABUS",
    "데스포르치": "DESPORTE",
    "하빈져": "HARBINGER",
    "스팔딩": "SPALDING",
    ...
    "무니치": "MUNICH",
    "하바이아나스": "HAVAIANAS",
    "레인보우샌들": "RAINBOW SANDALS",
    "코베아 낚시": "KOVEA",
    "카스크": "KASK",
    "캘러웨이": "CALLAWAY",
    "풋조이골프": "FOOTJOY GOLF",
    "록시": "ROXY",
    "씨엘르 애슬레틱": "CIELLE ATHLETICS",
    "고요웨어": "GOYOWEAR",
    "노드랩스": "NODE LABS",
    "브룩스": "BROOKS",
    "퍼글러": "FUGGLER",
