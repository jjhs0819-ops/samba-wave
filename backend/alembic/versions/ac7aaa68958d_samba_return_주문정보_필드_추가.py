...
def upgrade() -> None:
    ...
    op.add_column('samba_return', sa.Column('confirmed', sa.Boolean(), server_default='false', nullable=False))
    op.add_column('samba_return', sa.Column('order_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('samba_return', sa.Column('settlement_amount', sa.Float(), nullable=True))
    op.add_column('samba_return', sa.Column('recovery_amount', sa.Float(), nullable=True))
