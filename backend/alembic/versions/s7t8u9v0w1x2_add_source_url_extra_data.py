...
def upgrade() -> None:
    # 1. 컬럼 추가
    op.add_column('samba_collected_product', sa.Column('source_url', sa.Text(), nullable=True))
    op.add_column('samba_collected_product', sa.Column('extra_data', sa.JSON(), nullable=True))
