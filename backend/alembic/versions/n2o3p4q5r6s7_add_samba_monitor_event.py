...
def upgrade() -> None:
    ...
    op.create_index('ix_samba_monitor_event_event_type', 'samba_monitor_event', ['event_type'])
    op.create_index('ix_samba_monitor_event_created_at', 'samba_monitor_event', ['created_at'])
    op.create_index('ix_samba_monitor_event_product_id', 'samba_monitor_event', ['product_id'])
