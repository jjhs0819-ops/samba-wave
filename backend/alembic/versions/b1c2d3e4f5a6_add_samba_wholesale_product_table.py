...
def upgrade() -> None:
    ...
    # 인덱스 생성
    op.create_index(
        op.f("ix_samba_wholesale_product_tenant_id"),
        "samba_wholesale_product",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_samba_wholesale_product_source_mall"),
        "samba_wholesale_product",
        ["source_mall"],
        unique=False,
    )
    op.create_index(
        op.f("ix_samba_wholesale_product_product_id"),
        "samba_wholesale_product",
        ["product_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_samba_wholesale_product_product_id"),
        table_name="samba_wholesale_product",
    )
    op.drop_index(
        op.f("ix_samba_wholesale_product_source_mall"),
        table_name="samba_wholesale_product",
