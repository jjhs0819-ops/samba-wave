...
def upgrade() -> None:
    op.add_column(
        "samba_collected_product", sa.Column("video_url", sa.Text(), nullable=True)
    )
    op.add_column(
        "samba_collected_product", sa.Column("style_code", sa.Text(), nullable=True)
    )
    op.add_column("samba_collected_product", sa.Column("sex", sa.Text(), nullable=True))
    op.add_column(
        "samba_collected_product", sa.Column("season", sa.Text(), nullable=True)
    )
    op.add_column(
