...
export const STORE_MARKETS: MarketConfig[] = [
  ...
  { key: 'gmarket', label: '지마켓', authField: 'storeId', fields: [
    ...
    { name: 'shippingCompanyNo', label: '발송 택배사', type: 'select', options: [
      { value: '', label: '설정안함' },
      { value: '10013', label: 'CJ대한통운' },
      { value: '10008', label: '롯데택배' },
      { value: '10003', label: '로젠택배' },
      { value: '10007', label: '한진택배' },
      { value: '10005', label: '우체국' },
    ]},
  ...
  { key: '11st', label: '11번가', authField: 'apiKey', guideUrl: 'https://openapi.11st.co.kr/openapi/OpenApiServiceRegister.tmall', fields: [
    ...
    { name: 'asPhone', label: 'A/S 전화번호', type: 'text', placeholder: '' },
    { name: 'asMessage', label: 'A/S안내', type: 'text', placeholder: '' },
    ...
    { name: 'returnExchangeGuide', label: '반품/교환 안내', type: 'text', placeholder: '' },
  ...
  { key: 'toss', label: '토스', authField: 'apiKey', guideUrl: 'https://shopping-docs.toss.im/dev', fields: [
    ...
    { name: 'asPhone', label: 'A/S 전화번호', type: 'text', placeholder: '' },
    { name: 'asMessage', label: 'A/S 안내 문구', type: 'text', placeholder: '' },
    { name: '_divider_toss_reg', label: '등록 필수값 (토스셀러에서 확인)', type: 'divider' },
    { name: 'deliveryLocationId', label: '출고지(배송묶음그룹) ID', type: 'number', placeholder: '예: 1531077' },
    { name: 'exchangeRefundLocationId', label: '교환/반품지 ID', type: 'number', placeholder: '예: 1531079' },
    { name: 'noticeCategoryCode', label: '고시 카테고리코드', type: 'text', placeholder: 'SHOES / CLOTHING / BAG 등' },
    { name: 'deliveryFee', label: '배송비', type: 'number', placeholder: '0 (무료배송)' },
    { name: 'freeConditionAmount', label: '무료배송 조건금액', type: 'number', placeholder: '50000' },
    { name: 'discountRate', label: '즉시할인율(%)', type: 'number', placeholder: '0 (미설정)' },
    { name: 'returnFee', label: '반품배송비(편도)', type: 'number', placeholder: '3000' },
    { name: 'exchangeFee', label: '교환배송비(왕복)', type: 'number', placeholder: '6000' },
    { name: 'jejuFee', label: '제주/도서산간 추가비', type: 'number', placeholder: '3000' },
  ...
  { key: 'gsshop', label: 'GSSHOP', authField: 'apiKeyProd', guideUrl: 'https://partners.gsshop.com/api/apiMain', fields: [
    { name: 'businessName', label: '사업자명', type: 'text', placeholder: '상호명 입력' },
    { name: 'storeId', label: '스토어 ID (협력사코드)', type: 'text' },
  ...
  { key: 'hmall', label: 'HMALL', authField: 'apiKey', guideUrl: 'https://partner.hmall.com', fields: [
    { name: 'businessName', label: '제휴사명', type: 'text', placeholder: '예: 마늘' },
    { name: 'storeId', label: '협력사코드 (venCd)', type: 'text', placeholder: '예: 003766' },
    { name: 'apiId', label: 'APIM ID (이메일)', type: 'text', placeholder: 'example@naver.com' },
  ...
  { key: 'ebay', label: 'eBay', authField: 'oauthToken', guideUrl: 'https://developer.ebay.com/', fields: [
    ...
    { name: 'devId', label: 'Dev ID', type: 'text' },
