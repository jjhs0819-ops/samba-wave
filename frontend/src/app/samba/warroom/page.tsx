  ...
  const load = useCallback(async () => {
    try {
      const [dashboard, recentEvents, probeStatus, atStatus, scores] = await Promise.all([
        ...
        collectorApi.autotuneStatus().catch(() => ({ running: false, last_tick: null as string | null, cycle_count: 0, restart_count: 0, target: 'registered', refreshed_count: 0, breaker_tripped: {} as Record<string, number>, site_intervals: undefined as Record<string, number> | undefined, traffic: undefined as { collecting: boolean; transmitting: boolean; busy: boolean } | undefined })),
