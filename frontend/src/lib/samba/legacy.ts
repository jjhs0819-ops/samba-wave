...
export interface OrderDashboardStats {
  ...
  salesChange: number
  weekly: { date: string; sales: number; count: number; fulfillmentSales: number; fulfillmentCount: number; shippedCount: number; unshippedCount: number | null; newRegistered: number | null; netChange: number | null; registeredCount: number | null; collectedCount: number }[]
...
export const collectorApi = {
  ...
  dashboardStats: () =>
    request<{
      ...
      by_account: { account_id: string; market_name: string; account_label: string; registered: number; sold_products?: number; count_unit?: string; brands: { source_site: string; brand: string; registered: number }[] }[]
...
export interface SambaReturn {
  ...
  return_link_manual?: string;
  customer_phone_manual?: string;
  sourcing_order_no?: string;
  customer_id?: string;
  company?: string;
...
export const returnApi = {
  ...
  patch: (id: string, data: { confirmed?: boolean; settlement_amount?: number; recovery_amount?: number; check_date?: string; memo?: string; product_location?: string; completion_detail?: string; status?: string; customer_order_no?: string; original_order_no?: string; type?: string; market_order_status?: string; return_source?: string; customer_amount?: string; company_amount?: string; return_link_manual?: string; customer_phone_manual?: string; sourcing_order_no?: string }) =>
...
export interface SambaNameRule {
  ...
  market_prefixes?: Record<string, string>;
  market_suffixes?: Record<string, string>;
