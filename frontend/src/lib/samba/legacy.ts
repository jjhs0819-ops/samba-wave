...
export const collectorApi = {
  ...
  dashboardStats: () =>
    request<{
      ...
      by_account: { account_id: string; market_name: string; account_label: string; registered: number; sales_amount?: number; count_unit?: string; brands: { source_site: string; brand: string; registered: number }[] }[]
