...
export interface OrderDashboardStats {
  ...
  salesChange: number
  weekly: { date: string; sales: number; count: number; fulfillmentSales: number; fulfillmentCount: number; shippedCount: number; unshippedCount: number | null; newRegistered: number | null; marketDeleted: number; registeredCount: number | null; collectedCount: number }[]
